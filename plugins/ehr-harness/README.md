# EHR Harness Plugin (원본)

> 본 매뉴얼은 [qoxmfaktmxj/ehr-harness-plugin](https://github.com/qoxmfaktmxj/ehr-harness-plugin) 의 자체 사용 매뉴얼입니다. 본 fork 는 원본 코드를 그대로 보존하고 있고, 이 README 도 fork 시점의 원본 README 본문을 그대로 옮긴 것입니다.

> 본 fork (`ehr-harness-yearend`) 가 추가한 연말정산 패키지(`ehr-yearend-harness`) 안내는 [상위 README](../../README.md) 또는 [`plugins/ehr-yearend-harness/README.md`](../ehr-yearend-harness/README.md) 참고.
